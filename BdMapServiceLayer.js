define(["dojo/_base/declare",  
    ...
    function (declare, TiledMapServiceLayer) {  
        ...
        var clazz = declare(TiledMapServiceLayer, {  

            declaredClass: 'esri.layers.BdMapServiceLayer',
             ...
             * 百度地图服务图层构造函数。 
             *
             * @param type {String} - 地图类型，取值范围："normal | satellite | annotate"。默认为"normal"。
             */
            ...
            getTileUrl: function (level, row, col) {  
                ...
                var num = (col + row) % 8 + 1;  
                var tileUrl = "http://online" + num + ".map.bdimg.com/tile/?qt=tile&x="+numX+"&y="+numY+"&z="+level+"&styles=pl";
                if(this.type === "satellite"){
                    tileUrl = "http://shangetu" + num + ".map.bdimg.com/it/u=x="+numX+";y="+numY+";z="+level+";v=009;type=sate&fm=46"; 
                } else if(this.type === "annotate") {
                    tileUrl = "http://online" + num + ".map.bdimg.com/tile/?qt=tile&x="+numX+"&y="+numY+"&z="+level+"&styles=sl";                      //tileUrl = "http://online0.map.bdimg.com/onlinelabel/?qt=tile&x=409&y=111&z=11&styles=sl&p=0&v=083&udt=20150815";  
                }
